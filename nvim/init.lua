...
require('lazy').setup({
  ...
  -- @
  {
    'mbbill/undotree',
    keys = { -- stylua: ignore
      { '<leader>uu', '<Cmd>UndotreeToggle<Cr>', { desc = '[U]ndotree' } },
    },
  },
  ...
  { -- LSP Configuration & Plugins
    ...
    opts = {
      ...
      diagnostics = {
        ...
        signs = {
          text = {
            [vim.diagnostic.severity.ERROR] = require('kickstart.config').icons.diagnostics.Error,
            [vim.diagnostic.severity.WARN] = require('kickstart.config').icons.diagnostics.Warn,
            [vim.diagnostic.severity.HINT] = require('kickstart.config').icons.diagnostics.Hint,
            [vim.diagnostic.severity.INFO] = require('kickstart.config').icons.diagnostics.Info,
          },
        },
      },
    },
    config = function(_, opts)
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>sD', require('telescope.builtin').lsp_type_definitions, '[S]earch Type [D]efinition')
          ...
          vim.keymap.set('i', '<c-k>', vim.lsp.buf.signature_help, { desc = 'LSP: Function Signature' })
