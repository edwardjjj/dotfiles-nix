return {
  ...
  dependencies = {
    ...
    -- fancy UI for the debugger
    {
      ...
      keys = {
        ...
        { "<leader>dr", function() require("dapui").open({reset=true}) end, desc = "[D]ap [R]eset", mode = {"n"} },
      },
      opts = {},
    ...
    -- python dap
    {
      ...
      config = function()
        require('dap-python').setup '~/miniconda3/envs/nvim/bin/python'
      end,
    },
  ...
  keys = {
    ...
    { "<leader>dv", function() require("dap").step_over() end, desc = "Step O[v]er" },
  ...
  config = function()
    local Config = require 'kickstart.config'
